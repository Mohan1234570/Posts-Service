...
public class FollowerController {
    ...
    public ResponseEntity<?> followUser(
        ...
        followerService.follow(userId, targetId, tenantId);
        return ResponseEntity.ok(Map.of("message", "Followed"));
    }
    ...
    public ResponseEntity<?> unfollowUser(
        ...
        followerService.unfollow(userId, targetId, tenantId);
        return ResponseEntity.ok(Map.of("message", "Unfollowed"));
    }
    ...
    public ResponseEntity<?> checkStatus(
        ...
        boolean status = followerService.isFollowing(userId, targetId, tenantId);
        return ResponseEntity.ok(Map.of("isFollowing", status));
    }
}
